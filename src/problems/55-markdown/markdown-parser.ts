...
export const RICH_TEXT_RULES: Array<any> = [
    new TRichTextRule('link', [new TRichTextPattern(...LINK)]),
    new TRichTextRule('headings', [new TRichTextPattern(...HEADING_H6), new TRichTextPattern(...HEADING_H5), new TRichTextPattern(...HEADING_H4), new TRichTextPattern(...HEADING_H3), new TRichTextPattern(...HEADING_H2), new TRichTextPattern(...HEADING_H1)]),
    new TRichTextRule('table', [new TRichTextPattern(...TABLE)]),
    new TRichTextRule('lists', [new TRichTextPattern(...UNORDERED_LIST), new TRichTextPattern(...ORDERED_LIST)]),
    new TRichTextRule('paragraph', [new TRichTextPattern(...PARAGRAPH)]),
    new TRichTextRule('formatting', [new TRichTextPattern(...BOLD), new TRichTextPattern(...ITALIC), new TRichTextPattern(...STRIKETHROUGH)]),
]
